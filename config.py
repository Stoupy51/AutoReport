...
PLAYBACK_DEVICE_NAME: str = "speakers"			# Name of the speakers device to search for
...
MINIMUM_DURATION: float = 0.5					# Minimum duration (in seconds) of a sentence in the audio file
